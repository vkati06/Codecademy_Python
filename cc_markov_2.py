...
"""
Modification of he original Codecademy code: 
the text is splitted by a new line, instead of the original space.
"""
...
class MarkovChain:
  ...
  def __add_source_data(self, str):
    clean_str = self._punctuation_regex.sub('\n',str).lower()
    tuples = self.__generate_tuple_keys(clean_str.splitlines())
    for t in tuples:
